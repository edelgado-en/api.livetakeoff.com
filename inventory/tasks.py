...
# run notify_admins_flight_based_scheduled_cleaning everyday at 9:30am
scheduler.add_job(notify_admins_flight_based_scheduled_cleaning, 'cron', hour=9, minute=30, second=0)

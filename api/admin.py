...
class ServiceAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'short_name', 'description', 'short_description' , 'active', 'public', 'type', 'category', 'is_special', 'is_exterior_detail_level_1', 'is_exterior_detail_level_2', 'is_interior_detail_level_1', 'is_interior_detail_level_2']
    list_per_page = 100
...
class RetainerServiceAdmin(admin.ModelAdmin):
    list_display = ['name', 'short_name', 'description', 'short_description', 'active', 'category', 'is_special']
    list_per_page = 100
    ordering = ['name', 'active']
    search_fields = ['name', 'active']
...
class CustomerSettingsAdmin(admin.ModelAdmin):
    list_display = ['id', 'customer', 'enable_request_priority', 'show_spending_info', 'allow_cancel_job', 'retainer_amount', 'special_instructions', 'price_list', 'enable_flight_based_scheduled_cleaning']
    list_per_page = 100
